...
Specify plant hydraulic parameters that are held constant at the subdaily to annual time scale. We also specify, constant environmental parameters.
```{r}
par_plant_std = list(
    Ks0=1e-12, 
    v_huber=1e-4, 
...
Thus, a forest with $LAI = 2$ will transpire 
```{r}
cat("E_forest = ", E*m_per_s_to_mm_per_day*365*2," mm/year")
```
